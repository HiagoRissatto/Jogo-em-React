...
const [historico, setHistorico] = useState<{ id: number; acao: string; resultado: string }[]>([]);
      ...
      <div className="container py-5">
        ...
        <div className="card bg-secondary bg-opacity-25 border-secondary p-4 mt-4">
          ...
          <div className='d-flex justify-content-center flex-wrap'>
            <Eat  acoes={acoes} vida={vida} comida={comida} setComida={setComida} setVida={setVida} setAcoes={setAcoes} setHistorico={setHistorico} historico={historico}/>
            <Sleep  acoes={acoes} vida={vida} energia={energia} setVida={setVida} setEnergia={setEnergia} setAcoes={setAcoes} setHistorico={setHistorico} historico={historico}/>
          ...
          <div className="text-center mt-4">
            <p className="text-light">Ações realizadas: {acoes}</p>
          </div>
